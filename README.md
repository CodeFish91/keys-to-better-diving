...
[DRAFT] *The color code:*
- 🟢 *Mint green:* Standard & safety skills (the essentials for survival)
- 🔵 *Sky blue:* Buoyancy & movement (for perfect positioning in the water)
- 🟠 *Coral:* Advanced skills & rescue skills

*100% expandable:* Using the provided *STL files*, you can easily print new tags yourself on a 3D printer.
*Fully customizable:* For new specialty courses (such as Nitrox or Wreck), you can simply expand the system with your own colors and separate rings.

Tactile, motivating, and grows with your skills.
